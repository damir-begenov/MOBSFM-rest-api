...
router.get('/education', (req, res) => {
    db.task(async t => {
        ...
        const education_category_material = await t.manyOrNone('SELECT ec.name as nameaac, eem.* FROM education_educationmaterial AS eem INNER JOIN education_educationfile AS eef ON eem.id = eef.material_id INNER JOIN education_category AS ec ON eem.category_id = ec.id')
